...
WaterMedia supports a wide range of video formats through LibVLC, including:
- **MKV** (Matroska) - Full support with multiple audio/subtitle tracks
- **MP4** (MPEG-4)
- **AVI** (Audio Video Interleave)
- **MOV** (QuickTime)
- **WebM**
- **FLV** (Flash Video)
- And many more formats supported by VLC

See [MKV_SUPPORT.md](MKV_SUPPORT.md) for detailed information about MKV format support.
